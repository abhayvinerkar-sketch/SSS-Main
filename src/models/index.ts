...
export interface Question { id:string; subjectId:string; chapterId:string; text:string; options:string[]; answer:number; explanation:string; type:QuestionType; difficulty:Difficulty; marks:number; tags:string[]; }
